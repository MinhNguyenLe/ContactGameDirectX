...
void TankDoor::GetBoundingBox(float& left, float& top, float& right, float& bottom)
{
}

void TankDoor::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
...
void TankDoor::SetState(int state)
{
